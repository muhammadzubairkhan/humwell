...
Project Description: 
Humwell is a service that approaches the healthcare domain in a holistic manner; including healthcare services, access to medical consultation, laboratory services, prescription medicines, rental specialized equipment, an emergency helpline and personal point of care systems.
...
Built With: 
Bootstrap as CSS responsive bootstrap Fontawesome as iconification JQuery as JS extended library Simple line icons' CSS library to use slim and thin icons
